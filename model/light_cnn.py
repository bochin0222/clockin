...
class network_29layers_arcface(nn.Module):
    def __init__(self, block, layers):
        super(network_29layers_arcface, self).__init__()
        self.fp16 = False
        self.conv1    = mfm(3, 48, 5, 1, 2)
        self.block1   = self._make_layer(block, layers[0], 48, 48)
        self.group1   = group(48, 96, 3, 1, 1)
...
def LightCNN_29Layers_arcface(**kwargs):
    model = network_29layers_arcface(resblock, [1, 2, 3, 4], **kwargs)
    return model
